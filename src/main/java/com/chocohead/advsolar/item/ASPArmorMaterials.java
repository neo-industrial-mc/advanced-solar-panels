...
public final class ASPArmorMaterials {
    ...
    public static Holder<ArmorMaterial> create(String name, boolean dyeable) {
        ...
        List<ArmorMaterial.Layer> layers = dyeable
                ? List.of(new ArmorMaterial.Layer(texture, "", true), new ArmorMaterial.Layer(texture, "_overlay", false))
                : List.of(new ArmorMaterial.Layer(texture));
        return Holder.direct(new ArmorMaterial(defense, 0, SoundEvents.ARMOR_EQUIP_DIAMOND, Ingredient::of, layers, 2, 0));
    }
}
